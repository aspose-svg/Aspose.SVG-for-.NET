---
template: true
title: GIF zu JPG über C# zusammenführen - Aspose.SVG
description: Zusammenführen von GIF zu JPG mithilfe der .NET Core-API unter Windows, macOS und Linux
url: /de/net/merger/gif-to-jpg/
family: svg
platformtag: net
feature: conversion
informat: SVG
...
{{< blocks/products/pf/upper-banner h1="GIF zu JPG über C# zusammenführen" h2="Hochgeschwindigkeits-.NET-API zum Kombinieren von GIF-Dateien unter Windows, macOS und Linux" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/svg/headers/aspose_svg-for-net.svg" pfName="Aspose.SVG " subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/svg/net" >}}

{{< blocks/products/pf/main-container >}}

{{% blocks/products/pf/agp/content h2="GIF mit C# zu JPG zusammenführen" %}}

GIF-Dateien haben eine kleine Dateigröße, was sie ideal für die Verwendung auf Websites für Logos, Strichzeichnungen und einfache Cartoons macht. GIF und JPG sind die beliebtesten Formate für Grafikdateien im Web. Beide Dateiformate haben ihre eigenen Vor- und Nachteile, und in einigen Fällen müssen Sie möglicherweise GIF-Bilder kombinieren und als eine JPG-Datei speichern. Mit der API [Aspose.SVG for .NET](https://products.aspose.com/svg/net/) können Sie GIF programmgesteuert mit JPG zusammenführen. Die leistungsstarke C#-API hilft Ihnen, GIF-Dateien schnell und in hoher Qualität zu kombinieren!


<br>

<h2>C#-Codebeispiel zum Zusammenführen von GIF zu JPG</h2>
...
{{% blocks/products/pf/agp/code-block title="GIF zu JPG zusammenführen - C#" offSpacer="true" %}}
...
<h2>Schritte zum Zusammenführen von GIF zu JPG mit C#</h2>
...
1. Mehrere GIF-Bilder werden in einer JPG-Datei im angegebenen Pfad gespeichert.
