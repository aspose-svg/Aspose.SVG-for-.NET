---
template: true
title: Zusammenführen von SVG zu GIF über C# - Aspose.SVG
description: Zusammenführen von SVG zu GIF mit C# unter Windows, macOS und Linux
url: /de/net/merger/svg-to-gif/
family: svg
platformtag: net
feature: conversion
informat: SVG
...
{{< blocks/products/pf/upper-banner h1="SVG zu GIF über C# zusammenführen" h2="Hochgeschwindigkeits-.NET-API zum Kombinieren von SVG-Dateien unter Windows, macOS und Linux" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/svg/headers/aspose_svg-for-net.svg" pfName="Aspose.SVG " subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/svg/net" >}}

{{< blocks/products/pf/main-container >}}

{{% blocks/products/pf/agp/content h2="Zusammenführen von SVG zu GIF mit C#" %}}

SVG ist eines der am häufigsten verwendeten Formate zum Erstellen von Websites und zum Drucken von Grafiken, um Skalierbarkeit zu erreichen. Aber manchmal müssen Sie SVG-Dateien zusammenführen und sie als ein Dokument in einem anderen Dateiformat speichern. GIF ist eine Art stark komprimiertes Bild, das den LZW-Komprimierungsalgorithmus verwendet, der die Bildqualität nicht beeinträchtigt. Mit der API [Aspose.SVG for .NET](https://products.aspose.com/svg/net/) können Sie SVG programmgesteuert mit GIF zusammenführen. Die leistungsstarke C#-API hilft Ihnen, SVG-Dateien schnell und in hoher Qualität zu kombinieren!


<br>

<h2>C#-Codebeispiel zum Zusammenführen von SVG zu GIF</h2>
...
{{% blocks/products/pf/agp/code-block title="SVG zu GIF zusammenführen - C#" offSpacer="true" %}}
...
<h2>Schritte zum Zusammenführen von SVG zu GIF mit C#</h2>
...
1. Rufen Sie die Methode [Render()](https://reference.aspose.com/svg/net/aspose.svg.rendering/renderer-1/) auf, um SVG zu GIF-Bild zusammenzuführen.
1. Mehrere SVG-Dateien werden im GIF-Bild im angegebenen Pfad gespeichert.
