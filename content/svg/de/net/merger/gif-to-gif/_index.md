---
template: true
title: GIF zu GIF über C# zusammenführen - Aspose.SVG
description: Zusammenführen von GIF zu GIF mithilfe der .NET Core-API unter Windows, macOS und Linux
url: /de/net/merger/gif-to-gif/
family: svg
platformtag: net
feature: conversion
informat: SVG
...
{{< blocks/products/pf/upper-banner h1="GIF zu GIF über C# zusammenführen" h2="Hochgeschwindigkeits-.NET-API zum Kombinieren von GIF-Dateien unter Windows, macOS und Linux" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/svg/headers/aspose_svg-for-net.svg" pfName="Aspose.SVG " subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/svg/net" >}}

{{< blocks/products/pf/main-container >}}

{{% blocks/products/pf/agp/content h2="GIF zu GIF mit C# zusammenführen" %}}

GIF-Dateien haben eine kleine Dateigröße, was sie ideal für die Verwendung auf Websites für Logos, Strichzeichnungen und einfache Cartoons macht. Es wird schnell hochgeladen, da diese Dateien normalerweise eine niedrige Auflösung haben. In einigen Fällen müssen Sie möglicherweise GIF-Bilder kombinieren und als eine Datei speichern. Mit der API [Aspose.SVG for .NET](https://products.aspose.com/svg/net/) können Sie GIF programmgesteuert mit GIF zusammenführen. Die leistungsstarke C#-API hilft Ihnen, GIF-Dateien schnell und in hoher Qualität zu kombinieren!


<br>

<h2>C#-Codebeispiel zum Zusammenführen von GIF zu GIF</h2>

Kombinieren Sie mehrere GIF-Dateien und speichern Sie das Ergebnis ganz einfach als einzelne GIF-Datei! Das Zusammenführen von Bildern kann mit ein paar Zeilen Code erfolgen:

<br>

{{% blocks/products/pf/agp/code-block title="GIF zu GIF zusammenführen – C#" offSpacer="true" %}}
...
<h2>Schritte zum Zusammenführen von GIF zu GIF mit C#</h2>
...
1. Mehrere GIF-Bilder werden in einer GIF-Datei im angegebenen Pfad gespeichert.
...
{{< blocks/products/pf/agp/other-supported-section title="Andere unterstützte Fusionen" subTitle="Sie können Bilder in andere Dateiformate zusammenführen:" >}}
