---
template: true
title: Zusammenführen von PNG zu BMP über C# - Aspose.SVG
description: Zusammenführen von PNG zu BMP mit C# unter Windows, macOS und Linux
url: /de/net/merger/png-to-bmp/
family: svg
platformtag: net
feature: conversion
informat: SVG
...
{{< blocks/products/pf/upper-banner h1="PNG zu BMP über C# zusammenführen" h2="Hochgeschwindigkeits-.NET-API zum Kombinieren von PNG-Dateien unter Windows, macOS und Linux" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/svg/headers/aspose_svg-for-net.svg" pfName="Aspose.SVG " subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/svg/net" >}}

{{< blocks/products/pf/main-container >}}

{{% blocks/products/pf/agp/content h2="PNG zu BMP mit C# zusammenführen" %}}

PNG bezieht sich auf eine Art von Rasterbilddateiformat, das verlustfreie Komprimierung verwendet, was es bei Benutzern beliebt macht. Grafikdateien im BMP-Format sind unkomprimierte Bitmap-Bilder, daher haben BMP-Bilder eine höhere Auflösung als PNG-Bilder. Beide Dateiformate haben ihre eigenen Vor- und Nachteile, und in einigen Fällen müssen Sie möglicherweise PNG-Bilder kombinieren und als eine BMP-Datei speichern. Mit der API [Aspose.SVG for .NET](https://products.aspose.com/svg/net/) können Sie PNG programmgesteuert mit BMP zusammenführen. Die leistungsstarke C#-API hilft Ihnen, PNG-Dateien schnell und in hoher Qualität zu kombinieren!


<br>

<h2>C#-Codebeispiel zum Zusammenführen von PNG zu BMP</h2>

Kombinieren Sie mehrere PNG-Dateien und speichern Sie das Ergebnis ganz einfach als einzelne BMP-Datei! Das Zusammenführen von Bildern kann mit ein paar Zeilen Code erfolgen:

<br>

{{% blocks/products/pf/agp/code-block title="PNG zu BMP zusammenführen - C#" offSpacer="true" %}}
...
<h2>Schritte zum Zusammenführen von PNG zu BMP mit C#</h2>
...
1. Mehrere PNG-Bilder werden in einer BMP-Datei im angegebenen Pfad gespeichert.
