...
<h2>Steps to Convert SVG to JPEG using ConvertSVG() Method</h2>
...
<h2>Steps to Convert SVG to JPEG using RenderTo() Method</h2>
...
{{% blocks/products/pf/agp/code-block title="Convert SVG to JPEG" offSpacer="true" %}}
