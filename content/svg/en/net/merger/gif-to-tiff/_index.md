---
template: true
title: Merge GIF to TIFF via C# - Aspose.SVG
description: Merge GIF to TIFF using .NET Core API on Windows, macOS & Linux
...
{{< blocks/products/pf/upper-banner h1="Merge GIF to TIFF via C#" h2="High-speed .NET API to combine GIF files on Windows, macOS & Linux" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/svg/headers/aspose_svg-for-net.svg" pfName="Aspose.SVG " subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/svg/net" >}}

{{< blocks/products/pf/main-container >}}

{{% blocks/products/pf/agp/content h2="Merge GIF to TIFF Using C#" %}}

GIF and TIFF are file formats used for storing digital images. However, they do differ in the manner they are used. GIF files have a small file size, making them ideal for website usage for logos, line art and simple cartoons. On the other hand, TIFF is popular among graphic artists, the publishing industry, and amateur and professional photographers. Both file formats have their own pros and cons, and in some cases, you may need to combine GIF images and save them as one TIFF file. With [Aspose.SVG for .NET](https://products.aspose.com/svg/net/) API, you can merge GIF to TIFF programmatically. Powerful C# API helps you to combine GIF files quickly and in high quality!


<br>

<h2>C# code example to merge GIF to TIFF</h2>

Combine multiple GIF files and save the result as a single TIFF file easily! Merging images can be done with a few lines of code:

<br>

{{% blocks/products/pf/agp/code-block title="Merge GIF to TIFF - C#" offSpacer="true" %}}
...
<h2>Steps to Merge GIF to TIFF using C#</h2>
...
1. Multiple GIF images will be saved into one TIFF file on the specified path.
