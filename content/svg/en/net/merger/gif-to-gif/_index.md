...
{{< blocks/products/pf/upper-banner h1="Merge GIF to GIF via C#" h2="High-speed .NET API to combine GIF files on Windows, macOS & Linux" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/svg/headers/aspose_svg-for-net.svg" pfName="Aspose.SVG " subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/svg/net" >}}

{{< blocks/products/pf/main-container >}}

{{% blocks/products/pf/agp/content h2="Merge GIF to GIF Using C#" %}}
...
<h2>C# code example to merge GIF to GIF</h2>
...
{{% blocks/products/pf/agp/code-block title="Merge GIF to GIF - C#" offSpacer="true" %}}
...
<h2>Steps to Merge GIF to GIF using C#</h2>
