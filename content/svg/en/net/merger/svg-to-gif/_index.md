---
template: true
title: Merge SVG to GIF via C# - Aspose.SVG
description: Merge SVG to GIF using C# on Windows, macOS & Linux
...
{{% blocks/products/pf/agp/content h2="Merge SVG to GIF Using C#" %}}
...
1.  Multiple SVG files will be saved to the GIF image on the specified path.
