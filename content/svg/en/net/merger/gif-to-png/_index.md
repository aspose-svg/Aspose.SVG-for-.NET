---
template: true
title: Merge GIF to PNG via C# - Aspose.SVG
description: Merge GIF to PNG using .NET Core API on Windows, macOS & Linux
...
{{< blocks/products/pf/upper-banner h1="Merge GIF to PNG via C#" h2="High-speed .NET API to combine GIF files on Windows, macOS & Linux" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/svg/headers/aspose_svg-for-net.svg" pfName="Aspose.SVG " subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/svg/net" >}}

{{< blocks/products/pf/main-container >}}

{{% blocks/products/pf/agp/content h2="Merge GIF to PNG Using C#" %}}

GIF files have a small file size, which makes them ideal for website usage for logos, line art and simple cartoons. GIF and PNG are the most popular formats for graphics files on the Web. Both file formats have their own pros and cons, and in some cases, you may need to combine GIF images and save them as one PNG file. With [Aspose.SVG for .NET](https://products.aspose.com/svg/net/) API, you can merge GIF to PNG programmatically. Powerful C# API helps you to combine GIF files quickly and in high quality!


<br>

<h2>C# code example to merge GIF to PNG</h2>

Combine multiple GIF files and save the result as a single PNG file easily! Merging images can be done with a few lines of code:

<br>

{{% blocks/products/pf/agp/code-block title="Merge GIF to PNG - C#" offSpacer="true" %}}
...
<h2>Steps to Merge GIF to PNG using C#</h2>
...
1. Multiple GIF images will be saved into one PNG file on the specified path.
