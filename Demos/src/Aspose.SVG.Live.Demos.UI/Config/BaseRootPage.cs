...
namespace Aspose.SVG.Live.Demos.UI.Config
{
    ...
    {
        private AsposeSVGContext _atcContext;
        ...
        /// </summary>
        public AsposeSVGContext AsposeSVGContext
		{
            get
            {
                if (_atcContext == null) _atcContext = new AsposeSVGContext(HttpContext.Current);
                return _atcContext;
            }
        }
		...
		public Dictionary<string, string> Resources
		{
			get
			{
				if (_resources == null) _resources = AsposeSVGContext.Resources;
				return _resources;
			}
		}
		protected override void OnInit(EventArgs e)
        {
            ...
            if (AsposeSVGContext.Session != null)
            {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            AsposeSVGContext.atcc = AsposeSVGContext;
            base.OnLoad(e);
        }
    }
}
