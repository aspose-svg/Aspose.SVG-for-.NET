...
/// </summary>
namespace Aspose.SVG.Live.Demos.UI.Config
{
	public static class Configuration
	{		
		private static string _appName = ConfigurationManager.AppSettings["AppName"].ToString();
		private static string _asposeSVGLiveDemosPath = ConfigurationManager.AppSettings["AsposeSVGLiveDemosPath"].ToString();
		...
		private static string _productsAsposeSVGAssetURL = ConfigurationManager.AppSettings["ProductsAsposeSVGAssetURL"];
		...
		public static string ProductsAsposeSVGAssetURL
		{
			get { return _productsAsposeSVGAssetURL; }
		}	
        ...
        public static string AsposeSVGLiveDemosPath
        {
            get { return _asposeSVGLiveDemosPath; }
        }
