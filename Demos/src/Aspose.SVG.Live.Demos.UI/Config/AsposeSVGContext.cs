...
{
	/// <summary>
	/// Wrapper class for Aspose.SVG context access to Pages and controls
	/// </summary>
	public class AsposeSVGContext : Context
	{
		/// <summary>
		...
		/// </summary>
		/// <param name="hc"></param>
		internal AsposeSVGContext(HttpContext hc) : base(hc) { Thread.SetData(Thread.GetNamedDataSlot(Configuration.ResourceFileSessionName + "ContextSlot"), hc); }
		private static AsposeSVGContext atc;
		/// <summary>
		///  Use for internal syncing of the context
		/// </summary>
		internal static AsposeSVGContext atcc { set { atc = value; } }
		internal static AsposeSVGContext Current
		{
			get { return atc; }
		}
