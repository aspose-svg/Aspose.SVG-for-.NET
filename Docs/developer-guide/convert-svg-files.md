...
### **Convert SVG to JPEG**
A [JPEG](https://wiki.fileformat.com/image/jpeg/) image is a compressed file that uses lossy compression to reduce the image file size while compromising on the image quality. The compression level can be adjusted to achieve the desired quality level while at the same time reduce the storage size. A higher compression value results in higher degradation of the image quality.
...
1. We create a instance of the SVGDocument class from the string source.
1. In the next step, we create an instance of the ImageDeivce class. The constructor of this device accepts [ImageRendering](https://apireference.aspose.com/svg/net/aspose.svg.rendering.image/imagerenderingoptions) options that determine the rendering process and the result file.
...
### **Convert SVG to BMP**
Aspose.SVG for .NET (C#, VB.NET) lets you convert your SVG files to rasterized Bitmaps using a few lines of code. The BMP file format has been the initial image file format and was widely used for graphical representation and storing images.
The following code sample shows how to use Aspose.SVG API to convert SVG to BMP file format.

{{< gist "aspose-com-gists" "0420a5530f73658aebea7f98ea4d705f" "Examples-CSharp-LoadSaveConvert-ConvertSVGToImage-ConvertBMP.cs" >}}
### **Convert SVG to GIF**
...
{{< gist "aspose-com-gists" "0420a5530f73658aebea7f98ea4d705f" "Examples-CSharp-LoadSaveConvert-ConvertSVGToImage-ConvertGIF.cs" >}}
### **Convert SVG to TIFF**
...
{{< gist "aspose-com-gists" "0420a5530f73658aebea7f98ea4d705f" "Examples-CSharp-LoadSaveConvert-ConvertSVGToImage-ConvertTIFF.cs" >}}
